...
class Report extends Component{
    ...
    async componentDidMount(){
        ...
        if(loggedInFor === "company"){
            ...
            const response = await fetch("https://ec2-35-88-117-254.us-west-2.compute.amazonaws.com:8081/api/company/report/"+email);
        ...
        if(loggedInFor === "candidate"){
            ...
            const response = await fetch("https://ec2-35-88-117-254.us-west-2.compute.amazonaws.com:8081/api/candidate/report/"+email);
            const body = await response.json();
            console.log(body);
            this.setState({ allQuestion: body, isLoaded:true });
        }
